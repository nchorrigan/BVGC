...
require_once (dirname(__FILE__) . "/../Includes/simplecms-config.php");
...
<div id="main">
    ...
    <form action="editpage.php" method="post">
			...
			<input type="hidden" id="pageId" name="pageId" value="<?php echo $pageId; ?>" />
                        <label for="menulabel">Page title</label> 
                        <input type="text" name="menulabel" value="<?php echo $menulabel; ?>" id="menulabel" />
                    </li>
                    <li>
                        <label for="content">Page Content:</label>
                        <textarea name="content" id="content" class="wysiwyg" style="width:98%"><?php echo $content; ?></textarea>
                    </li>
                </ol>
